    ...
    <table class="table table-hover mt-4">
        <thead>
            <tr>
                <th scope="col">#</th>
                <th scope="col">Nom</th>
                <th scope="col">Ordre dans le Footer</th>
                <th scope="col"></th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td class="text-right">
                    ...
                    <div class="btn-group">
                        <button brand="button" class="btn btn-sm btn-danger dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
